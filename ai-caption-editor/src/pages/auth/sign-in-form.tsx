...
export function SignInForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    setLoading(true)
    try {
      await auth.login({ email, password, remember: !!form.get('remember') })
      navigate('/dashboard')
    } finally {
      setLoading(false)
    }
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <Checkbox
            ...
            label="Remember me"
          />
          <span className="flex items-center gap-1.5 rounded-md border border-zinc-700/50 px-2 py-0.5 text-xs text-zinc-500">
